ministrat.config.cities = {
  ...
  halle: {
    ...
    marker_selector: "[id='image845-9-2-3']", // Note: Special selector
  },
  karl_marx_stadt: {
    controller: "ddr",
    owner: "ddr",
  ...
  leipzig: {
    ...
    marker_selector: "[id='image845-9-2']", // Note: Special selector
  },
  magdeburg: {
    controller: "ddr",
    owner: "ddr",
  ...
  //East Germany - Minor Cities
  brandenburg_an_der_havel: {
    controller: "ddr",
    owner: "ddr",
    size: 1, // Assumed default
  ...
  waldsiedlung: {
    ...
    is_capital: true,
    size: 1, // Assumed default
    label_selector: "[id='eberswalde-9']", // Note: Special selector
    marker_selector: "[id='eberswalde-marker-0']", // Note: Special selector
  },
  zwickau: {
    controller: "ddr",
    owner: "ddr",
  ...
  hameln: {
    ...
    owner: "brd",
    size: 1, // Assumed default
    label_selector: "#hammeln", // Note: Original label selector was "#hammeln"
  ...
  bonn: {
    ...
    size: 1, // Assumed default
    label_selector: "#bonn",
    marker_selector: "#eberswalde-marker-0-8", // Note: Special selector
  },
  detmold: {
    controller: "brd",
    owner: "brd",
