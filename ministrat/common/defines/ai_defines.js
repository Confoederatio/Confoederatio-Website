config.defines.ai = {
  enemy_capital_base_value: 100,
  enemy_city_base_value: 20,
  enemy_city_value_per_size: 50, //After size: 1
  ...
  //Graphs per faction; excludes player by default, who has a special flowfield
  team_graphs: {
    nato: ["nato", "brd"],
    wto: ["wto", "ddr"]
  }
