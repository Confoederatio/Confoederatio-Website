//Initialise banner namespace
{
  ...
  function homepageAboutOnScroll () {
    try {
      ...
      var banner_obj = window.main.banner;

      //16vh offset
      banner_obj.about_me_overlay_title.style.transform = `
        translateY(${(16/160)*scroll_vh}vh)
      `;

      //24vh offset
      banner_obj.about_me_overlay_subtitle.style.transform = `
        translateY(${(48/160)*scroll_vh}vh)
      `;
      banner_obj.biography_overlay_subtitle.style.transform = `
        translateY(${(48/160)*scroll_vh}vh)
      `;
      ...
      //20vh offset
      banner_obj.about_me_body_text.style.transform = `
        translateY(${(56/160)*scroll_vh}vh)
      `;
      banner_obj.biography_body_text.style.transform = `
        translateY(${(56/160)*scroll_vh}vh)
      `;
